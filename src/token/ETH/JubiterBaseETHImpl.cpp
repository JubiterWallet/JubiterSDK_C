...
//
//
//JUB_RV JubiterBaseETHImpl::_serializeUnsignedTx(const uint32_t coin,
...
//
//
//JUB_RV JubiterBaseETHImpl::SerializeUnsignedTx(const JUB_ENUM_BTC_TRANS_TYPE& type,
//                                               const std::vector<INPUT_BTC>& vInputs,
//                                               const std::vector<OUTPUT_BTC>& vOutputs,
...
//
//
//JUB_RV JubiterBaseETHImpl::_verifyPayToPublicKeyHashScriptSig(const TWCoinType& coin,
...
//
//
//JUB_RV JubiterBaseETHImpl::_verifyTx(const TWCoinType& coin,
//                                     const TW::Bitcoin::Transaction* tx,
...
//
//
//JUB_RV JubiterBaseETHImpl::VerifyTx(const bool witness,
...
//
//
//JUB_RV JubiterBaseETHImpl::_serializeTx(bool witness,
//                                        const std::vector<JUB_UINT64>& vInputAmount,
//                                        const std::vector<TW::Data>& vInputPublicKey,
