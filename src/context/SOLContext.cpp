...
JUB_RV SOLContext::GetAddress(const BIP44_Path& path, const JUB_UINT16 tag, std::string& address) {
...
JUB_RV SOLContext::SetMyAddress(const BIP44_Path& path, std::string& address) {
...
JUB_RV SOLContext::GetAddress(const BIP48_Path& path, const JUB_UINT16 tag, std::string& address) {
...
JUB_RV SOLContext::GetHDNode(const JUB_BYTE format, const BIP44_Path& path, std::string& pubkey) {
...
JUB_RV SOLContext::GetHDNode(const JUB_BYTE format, const BIP48_Path& path, std::string& pubkey) {
...
//JUB_RV SOLContext::SignTransaction(const BIP44_Path& path,
...
//
//
//JUB_RV SOLContext::SignTransaction(const BIP48_Path& path,
//                                   JUB_CHAR_CPTR chainID,
//                                   JUB_CHAR_CPTR expiration,
//                                   JUB_CHAR_CPTR referenceBlockId,
//                                   JUB_CHAR_CPTR referenceBlockTime,
...
//
//
//JUB_RV SOLContext::BuildAction(const JUB_ACTION_EOS_PTR actions,
