...
//                         JUB_UINT32 timeout);
- (NSUInteger)JUB_connectDevice:(NSString*)bBLEUUID
                        ...
                        timeout:(NSUInteger)timeout
{
    ...
    JUB_RV rv = JUB_connectDevice((JUB_BYTE_PTR)[bBLEUUID UTF8String],
...
- (void)JUB_cancelConnect:(NSString*)bBLEUUID
{
    _lastError = JUB_cancelConnect((JUB_BYTE_PTR)[bBLEUUID UTF8String]);
}
