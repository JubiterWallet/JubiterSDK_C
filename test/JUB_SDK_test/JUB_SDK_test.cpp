...
void getVersion(JUB_UINT16 deviceID) {
    ...
    JUB_BYTE bleVersion[5] = {
        0,
    };
    JUB_BYTE fwVersion[5] = {
        0,
    };
    ...
    for (auto appID : vAppList) {
        ...
        if (JUBR_OK != rv) {
            ...
            cout << appID << "    Applet Version : " << version.major << "." << version.minor << "." << version.patch
                 << endl;
        }
    }
...
void main_test() {
    ...
    try {
        ...
        while (true) {
            ...
            cout << "|  36.   BTC_P2TR                         |" << endl;
            cout << "|  37.   BTC_P2TR_test(Test Net).         |" << endl;
            ...
            case 35:
                ...
                break;
            case 36:
                json_file += "testBTC86.json";
                BTC_test(deviceID, json_file.c_str(), COINBTC);
                break;
            case 37:
                json_file += "testBTCTN86.json";
                BTC_test(deviceID, json_file.c_str(), COINBTC);
                break;
            case 39:
