...
class JubiterBaseTRXImpl : public TRXTokenInterface {
  public:
    JubiterBaseTRXImpl() {
    ...
    virtual JUB_RV PackTransactionRaw(const JUB_TX_TRX &tx, std::string &packedContractInPB) override;
    virtual JUB_RV SerializeContract(const JUB_CONTRACT_TRX &contract, ::google::protobuf::Any &parameter) override;
    virtual JUB_RV SerializePreimage(const std::string &packedContractInPb, uchar_vector &preimageRaw) override;
