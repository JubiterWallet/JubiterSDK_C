...
class JubiterBIOETHImpl : public JubiterBIOToken, public JubiterBladeETHImpl {
  public:
    JubiterBIOETHImpl(JUB_UINT16 deviceID)
        : JubiterBIOToken(deviceID), JubiterBladeETHImpl(deviceID), JubiterBladeToken(deviceID) {}
