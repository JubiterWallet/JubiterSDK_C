...
class JubiterBaseEOSImpl : public EOSTokenInterface {
  public:
    JubiterBaseEOSImpl() {
    ...
    virtual JUB_RV SerializePreimage(const std::string &expiration, const std::string &referenceBlockId,
                                     const std::string &referenceBlockTime, const std::string &actionsInJSON,
                                     uchar_vector &preimageRaw, const bool bWithType) override;
