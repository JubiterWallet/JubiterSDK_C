...
constexpr JUB_BYTE kPKIAID_NFC_DOMAIN[8] = {0xA0, 0x00, 0x00, 0x01, 0x51, 0x00, 0x00, 0x00};

// D1560001328300424C4400006E666301
constexpr JUB_BYTE kPKIAID_NFC[16] = {0xD1, 0x56, 0x00, 0x01, 0x32, 0x83, 0x00, 0x42,
                                      0x4C, 0x44, 0x00, 0x00, 0x6E, 0x66, 0x63, 0x01};
// bixin: D156000132834001
// constexpr JUB_BYTE kPKIAID_NFC[8] = {
//     0xD1, 0x56, 0x00, 0x01, 0x32, 0x83, 0x40, 0x01
// };

class JubiterLiteToken : virtual public JubiterBladeToken {
  public:
  ...
  protected:
    ...
    virtual JUB_RV _SetMnemonic(const std::string &pinMix, const JUB_ENUM_MNEMONIC_STRENGTH &strength,
                                const std::string &entropy, const std::string &seed);
    virtual JUB_RV _GetEntropy(const std::string &pinMix, std::string &entropy);
    virtual JUB_RV _SendApdu(const APDU *apdu, JUB_UINT16 &wRet, JUB_BYTE *retData = nullptr,
                             JUB_ULONG *pulRetDataLen = nullptr, JUB_ULONG ulMiliSecondTimeout = 1200000) override;
    JUB_RV _SendSafeApdu(const APDU *apdu, JUB_UINT16 &wRet, JUB_BYTE *retData = nullptr,
    ...
    virtual JUB_RV MutualAuthenticate(const uchar_vector &apduData, uchar_vector &receipt);
