...
class JubiterLiteDOTImpl : public JubiterLiteImpl, public JubiterBaseDOTImpl {
  ...
  public:
    ...
    JubiterLiteDOTImpl(JUB_UINT16 deviceID) : JubiterLiteImpl(deviceID), JubiterBladeToken(deviceID) {}
    ~JubiterLiteDOTImpl() {}
